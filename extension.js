        ...
        name: "魔法纪录", arenaReady: function () {
            ...
            character: {
                character: {
                    ...
                    ui: ["female", "ma", 3, ["ui_jinghua", "ui_leshan", "dckrmingshi"], ["doublegroup:huan:ma"]],
                },
                translate: {
            ...
            skill: {
                    ...
                    "ui_jinghua": {
                        ...
                        async content(event, trigger, player) {
                            let result = await player
                                .chooseTarget([1, game.players.length], "弃置每名角色各一张判定区的牌", function (card, player, target) {
                            ...
                            for (let target of result.targets) {
                                target.discard(target.getCards("j")[0]);
                            }
                ...
                translate: {
                    ...
                    "ui_jinghua": "净化",
                    "ui_jinghua_info": "你的准备阶段开始时，你可依次弃置一名武将判定区里存在的一个延时类锦囊，并额外摸等量的牌。",
                    "ui_leshan": "乐善",
            ...
            forumURL: "",
            version: "1.1",
        }, files: { "character": ["name.jpg", "madoka.jpg", "nanaka.jpg", "ayame.jpg", "yuma.jpg", "kirika.jpg", "oriko.jpg", "ashley.jpg", "rika.jpg", "riko.jpg", "alina.jpg", "Kagome.jpg", "mifuyu.jpg", "meru.jpg", "kanae.jpg", "mitama.jpg", "tsuruno.jpg", "sana.jpg", "iroha.jpg", "felicia.jpg", "kaede.jpg", "momoko.jpg", "asuka.jpg", "toka.jpg", "nemu.jpg", "yueye.jpg", "yuexiao.jpg", "homura.jpg", "homura2.jpg", "karin.jpg", "mami.jpg", "kyoko.jpg", "mabayu.jpg", "ren.jpg", "ulti_madoka.jpg", "sayaka.jpg", "kazumi.jpg", "kushu.jpg", "kokoro.jpg", "hanna.jpg", "anime_iroha.jpg", "yachiyo.jpg", "lena.jpg", "hazuki.jpg", "kuroe.jpg", "ui.jpg"], "card": [], "skill": [], "audio": [] }, connect: false
    }
};